...
const links = [
  { href: "/", label: "Trang chủ", short: "Home" },
  { href: "/schedule", label: "Lịch trình", short: "Schedule" },
  { href: "/goals", label: "Mục tiêu", short: "Goals" },
  { href: "/roadmap", label: "Hành trình", short: "Roadmap" },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between gap-3">
            <Link href="/" className="flex items-center gap-2 group shrink-0">
              ...
              <span className="font-bold text-lg tracking-tight hidden sm:inline">Today</span>
            </Link>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ...
                        : "text-text-secondary hover:text-primary hover:bg-tertiary/60",
                    )}
                  >
