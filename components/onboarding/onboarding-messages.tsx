...
export function OnboardingMessages({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <Dialog open onOpenChange={() => { /* undismissable */ }}>
      <DialogContent
        className="max-w-lg p-0 overflow-hidden bg-transparent border-0 shadow-none"
        showCloseButton={false}
      >
        <DialogTitle className="sr-only">Lời chào</DialogTitle>

        <div className="glass rounded-3xl p-7 sm:p-9 shadow-soft">
